  ...
  return (
    <>
      ...
      <Modal isOpen={showPrivacyModal} onClose={() => setShowPrivacyModal(false)} title="Privacy Policy">
        <p><em>Effective Date: July 13, 2026</em></p>
        <p>Welcome to shadowdynamicsystems.com, a proudly static site operated by Shadow Dynamic Systems LLC ("we," "our," "us").</p>
        <p>This Privacy Policy is intentionally simple, because our website is intentionally simple. We don't track you, profile you, or sell your data. We only keep what you give us.</p>
        <h4>1. What We Collect</h4>
        <p>If you use the contact form, we collect the information you choose to submit, such as your name, email address, organization, inquiry type, and message. You may ask us to delete it. We will do so.</p>
        <p>Your email, should you be one of the first poor souls to provide us with one, will only be used to contact you about things you have asked us to contact you about.</p>
        <ul>
          <li>No cookies.</li>
        ...
        <p>Your connection to this site is encrypted with SSL/TLS, just like every other sane website. SSL/TLS will be secure for at least the next month; we promise to watch the headlines for any sudden breakthroughs in Quantum Decryption.</p>
        <p>We take standard precautions against unauthorized access, malicious recursion, and bots attempting to solve us as a CAPTCHA.</p>
